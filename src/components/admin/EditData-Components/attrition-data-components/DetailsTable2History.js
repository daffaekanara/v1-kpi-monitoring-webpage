...
const DetailsTable2History = () => {

    const url = 'http://103.200.4.18:8181/api/admin/attrition/jrt_table'
    ...
    const columns=[
      ...
      {title: 'Category', field:'category', lookup: { 'Join': 'Join', 'Resign': 'Resign', 'Transfer In' : 'Transfer In', 'Transfer Out' : 'Transfer Out' }},
      {title: 'Date', field:'date', type:'date'},
      {title: 'Division', field:'division', lookup: divisionOption}
  ]

    return (
        <div>
            <h1 className='header'>Join/Resign/Transfer Table (History)</h1>
...
export default DetailsTable2History
