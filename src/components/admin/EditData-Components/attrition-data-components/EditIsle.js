...
const Editisle = () => {
    ...
    const url = 'http://156.67.217.92/api/admin/attrition_data/table_data'
    ...
    const columns=[
      ...
      {title:'Join', field:'join', type:'numeric'},
      {title:'Resign', field:'resign', type:'numeric'},
      {title:'Transfer', field:'transfer', type:'numeric'},
