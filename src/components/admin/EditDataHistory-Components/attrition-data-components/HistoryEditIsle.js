...
const HistoryEditIsle = () => {
    ...
    const url = 'http://103.200.4.18:8181/api/historic/attr/main/year'
    ...
    const columns=[
      ...
      {title:'Join', field:'join', editable:false},
      {title:'Rotation In', field:'rotation_in', editable:false},
      {title:'Resign', field:'resign', editable:false},
      {title:'Transfer Out', field:'transfer_out', editable:false},
      {title:'Transfer Out', field:'transfer_in', editable:false},
      {title:'Rotation Out', field:'rotation_out', editable:false},
