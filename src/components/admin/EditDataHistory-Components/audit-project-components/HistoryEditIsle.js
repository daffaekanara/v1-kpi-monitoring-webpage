...
const HistoryEditIsle = () => {
    ...
    const url = 'http://103.200.4.18:8181/api/historic/project/year'
    ...
    const columns=[
      ...
      {title:'TL NIK', field:'tl_nik'},
      {title:'Status', field:'status'},
      {title:'Use of DA', field:'useOfDA'},
      {title:'Year', field:'year'},
      {title:'Is Carried Over', field:'is_carried_over'},
      {title:'Timely Report', field:'timely_report'},
