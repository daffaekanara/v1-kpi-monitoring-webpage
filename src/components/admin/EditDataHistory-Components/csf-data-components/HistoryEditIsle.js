...
const HistoryEditIsle = () => {
    ...
    const url = 'http://103.200.4.18:8181/api/historic/csf/year'
    const url_title = 'http://103.200.4.18:8181/api/utils/title_project'
    const base_url_pdf = 'http://103.200.4.18:8181/api/utils/csf/show_aas/year/'
  ...
  const getDataPDF = () => {
    ...
    const columns=[
      ...
      {title:'Division (involevement)', field:'division_by_inv'}
  ]
