...
const Audit_exp_onclick = () => {
    ...
    const columns=[
      ...
      {title:'Total Year', field:'total_year'},
      {title:'Inside UOB', field:'inside_uob'},
      {title:'Outside UOB', field:'outside_uob'}
  ]

    return (
        <div className='container'>
            <h1 className='header'>Audit Experience</h1>
            <MaterialTable
...
export default Audit_exp_onclick
