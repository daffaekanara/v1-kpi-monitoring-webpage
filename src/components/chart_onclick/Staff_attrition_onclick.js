...
const Staff_attrition_onclick = () => {
  ...
  const columns=[
    ...
    {title:'Transfer In', field:'transfer_in', type:'numeric', editable:false},
  ...
  return (
      <div className='container'>
        <h1 className='header'>Staff Attrition</h1>
          <MaterialTable
...
export default Staff_attrition_onclick
