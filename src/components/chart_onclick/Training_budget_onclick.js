...
const Training_budget_onclick = () => {
    const columns=[
        ...
        {title:'Cost Realization', field:'costRealization', type:'numeric'},
      ...
      return (
          <div className='container'>
            <h1 className='header'>Training Budget</h1>
...
export default Training_budget_onclick
